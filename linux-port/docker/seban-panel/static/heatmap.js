(() => {
  ...
  const captions = {21:'Chunjo M1',23:'Chunjo M2',24:'Chunjo M3 — Waryong',25:'Łatwy Loch Małp',64:'Dolina Orków',63:'Pustynia Yongbi'};
  const backgrounds = {21:'chunjo-m1',23:'chunjo-m2',24:'guild-map-02',25:'easy-monkey',64:'orc-valley',63:'yongbi-desert'};
  async function render(){
    ...
    map.dataset.mapIndex=String(index); map.style.backgroundImage=`linear-gradient(#00000030,#00000030),url('/static/maps/${backgrounds[index]}.png')`;
