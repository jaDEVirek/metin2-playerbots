			...
			(
				{
					...
					"image" : "d:/ymir work/ui/game/windows/equipment_base.sub",  # equipment_bg_without_ring.tga nie istnieje w zadnej paczce (blad vendora) - to samo tlo 156x188 z okna postaci
