	...
	[
		{
			...
			[
				...
				{
					"name" : "always_show_name_group_button",
					"type" : "radio_button",

					"x" : LINE_DATA_X+MIDDLE_BUTTON_WIDTH,
					"y" : 190,

					"text" : uiScriptLocale.OPTION_ALWAYS_SHOW_NAME_GROUP,
				...
				{
					"name" : "show_damage_target_button",
					"type" : "radio_button",

					"x" : LINE_DATA_X+MIDDLE_BUTTON_WIDTH,
					"y" : 215,

					"text" : uiScriptLocale.OPTION_SHOW_DAMAGE_TARGET,
				...
				## NIGHT
				{
					...
					"text" : uiScriptLocale.GAME_OPTIONS_NIGHT_TITLE,
				},
				{
					"name" : "night_on_button",
					"type" : "radio_button",

					"x" : LINE_DATA_X,
					"y" : 240,

					"text" : uiScriptLocale.GAME_OPTIONS_NIGHT_0,
				...
				{
					"name" : "night_off_button",
					"type" : "radio_button",

					"x" : LINE_DATA_X+MIDDLE_BUTTON_WIDTH,
					"y" : 240,

					"text" : uiScriptLocale.GAME_OPTIONS_NIGHT_1,
				...
				{
					"name" : "night_auto_button",
					"type" : "radio_button",

					"x" : LINE_DATA_X+MIDDLE_BUTTON_WIDTH*2,
					"y" : 240,

					"text" : uiScriptLocale.GAME_OPTIONS_NIGHT_2,
				...
				## SHOP VISIBLE
				{
					"name" : "shop_visible_on_off",
					"type" : "text",

					"x" : LINE_LABEL_X,
					"y" : 290+2,

					"text" : uiScriptLocale.OPTION_VIEW_SHOP,
				},
				{
					"name" : "shop_visible_on_button",
					"type" : "radio_button",

					"x" : LINE_DATA_X,
					"y" : 290,

					"text" : uiScriptLocale.OPTION_VIEW_SHOP_ON,
				...
				{
					"name" : "shop_visible_found_button",
					"type" : "radio_button",

					"x" : LINE_DATA_X+MIDDLE_BUTTON_WIDTH,
					"y" : 290,

					"text" : uiScriptLocale.OPTION_VIEW_SHOP_FOUND,
				...
				},
				{
					...
					"type": "sliderbar",
					"x": LINE_DATA_X + MIDDLE_BUTTON_WIDTH - 47,
					"y": 321,
				},
				...
				## QUEST
				{
					...
					"text" : uiScriptLocale.GAME_OPTIONS_QUEST_TEXT_TITLE,
				},
				{
					"name" : "quest_text_default",
					"type" : "radio_button",

					"x" : LINE_DATA_X,
					"y" : 338,

					"text" : uiScriptLocale.GAME_OPTIONS_QUEST_TEXT_DELAY_0,
				...
				{
					"name" : "quest_text_fast",
					"type" : "radio_button",

					"x" : LINE_DATA_X+MIDDLE_BUTTON_WIDTH,
					"y" : 338,

					"text" : uiScriptLocale.GAME_OPTIONS_QUEST_TEXT_DELAY_1,
				...
				{
					"name" : "quest_text_no_delay",
					"type" : "radio_button",

					"x" : LINE_DATA_X+MIDDLE_BUTTON_WIDTH*2,
					"y" : 340,

					"text" : uiScriptLocale.GAME_OPTIONS_QUEST_TEXT_DELAY_2,
				...
				## FLOATING TEXT
				{
					...
					"text" : uiScriptLocale.GAME_OPTIONS_FLOATING_TEXT,
				},
				{
					"name" : "floating_text_left",
					"type" : "radio_button",

					"x" : LINE_DATA_X,
					"y" : 361,

					"text" : uiScriptLocale.GAME_OPTIONS_FLOATING_TEXT_0,
				...
				{
					"name" : "floating_text_right",
					"type" : "radio_button",

					"x" : LINE_DATA_X+MIDDLE_BUTTON_WIDTH,
					"y" : 361,

					"text" : uiScriptLocale.GAME_OPTIONS_FLOATING_TEXT_1,
